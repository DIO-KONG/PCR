...
EXPERIMENT_NAME = "world16_to_world14_parameter_sweep"

SOURCE = {"id": "world_16", "path": "data/raw/16/world.ply"}
...
def _run_variant(config: Mapping[str, Any], run_dir: Path, variant_name: str, params: Mapping[str, Any]) -> dict[str, Any]:
    ...
    record.update({"experiment_name": EXPERIMENT_NAME, "pair_id": "world_16_to_world_14", "variant_name": variant_name})
    return record
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run multi_comb parameter sweep on world_16 -> world_14.")
