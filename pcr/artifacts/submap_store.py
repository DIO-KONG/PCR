        ...
        for submap in manager.submaps:
            ...
            self.write_json(
                submap_dir / "metadata.json",
                {
                    ...
                    "provisional_depths": submap.provisional_depths,
                    "overlap_seed_candidates": submap.fused_batch_order,
                    "step_count": submap.step_count,
                    "fusion_step_history": submap.fusion_step_history,
                    "pose_rejected_history": submap.pose_rejected_history,
                    "scale_quarantine_history": submap.scale_quarantine_history,
                    "rotation_hold_reason": submap.rotation_hold_reason,
